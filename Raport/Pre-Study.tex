...
\textit{empathizing} with our user-base through conducting interviews both students and teachers across a wide range of
...
helping us put this information into a broader context.

\subsection{Interview highlights}\label{pre-study-interviews} %TODO ref should maybe go to building personas
...
represents the key entities and relationships within the system.
It includes the entities \textit{Lecturer}, \textit{Course}, \textit{Enrollment},
\textit{Student}, \textit{StudyGroup}, and \textit{University}.
In the context of model-driven engineering, this domain model can be considered a \textit{descriptive model},
as discussed by Heldal et al.~\cite{Descriptive_vs_prescriptive}.
Descriptive models aim to represent how a system
or domain currently exists, rather than defining how it should be implemented.

Our model focuses on capturing the structure of the academic environment based on insights from interviews and personas.
...
instructor, it became clear that the focus needed to shift away from implementation and toward understanding the problem domain.
