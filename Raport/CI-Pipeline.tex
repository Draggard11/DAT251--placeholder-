...
a minimal viable product is number one priority, but at a larger scale this doing as much automated testing as possible is beneficial
for quicker releases and feedback.

Google's initial large-scale CI setup evolved as it faced scalability issues. It tried to optimize it where it was possible and make it more and more efficient. \cite{GoogleTesting}
...
This approach forces developers to take care on the quality of the code they are producing. Also, building and testing as necessary as if that where to fail then the pipeline would as well.
